    ...
    <>
          <div className="grid xl:grid-cols-8 md:cols-5 sm:cols-3  gap-5 ps-4 ">
            {hours.map((wek,index) =>
              ...
              >
                <h2 className="xl:text-1xl pl-2 lg:overflow-clip pb-2">{formatTime(wek.datetime)}</h2>
          ...
          <div className=" grid gap-4 p-2 xl:grid-cols-3 md:grid-cols-1  justify-content-center">
            ...
            {selectedIndex && (
            <>
            <div className=" rounded-md m-2 pl-2 pt-2 bg-white h-50  mt-auto grid gap-7  mt-6">
            ...
            <div className=" m-2 pl-2 pt-2 bg-white rounded-md h-50  mt-auto grid gap-7  mt-6 ">
              <h4 className="text-3xl text-gray-400 pl-3"         >Wind Status</h4>
              <h2 className="text-2xl text-black text-center">{selectedIndex.windspeed}</h2>
              <p  className="text-1.5xl pl-3"                       >{getWindLabel(selectedIndex.windspeed)}</p>
            </div>
            <div className=" m-2 pl-2 pt-2 bg-white rounded-md h-50  mt-auto grid gap-7  mt-6  ">
